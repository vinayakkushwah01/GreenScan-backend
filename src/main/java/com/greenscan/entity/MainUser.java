...
@Data
@Entity
@Table(name = "main_user", indexes = {
    @Index(name = "idx_main_user_email", columnList = "email"),
    @Index(name = "idx_main_user_mobile", columnList = "mobile"),
    @Index(name = "idx_main_user_role", columnList = "role")
})
